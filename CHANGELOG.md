...
* explicitly provide `{ light, dark }` object syntax for Blume theme colors to prevent compiler from silently dropping strings

### [1.3.1](https://github.com/oldmanumby/gitwarp/compare/v1.3.0...v1.3.1) (2026-07-22)

### Bug Fixes

* initial attempt to add `blume.config.ts` theme override values using string shorthand (which failed to compile)
